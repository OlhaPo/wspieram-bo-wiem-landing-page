      ...
      <div className="mt-10">
        ...
        <div className="mt-10">
          ...
          <p>
            ...
            &laquo;яскраві&raquo; конфлікти, поява дітей, розподілення сімейних
            ролей та обов'язків, зрада, розлучення, тощо — пропоную Вам свої
            підтримку та супровід на шляху до пошуку найоптимальніших для Вас
            вирішень цих складних життєвих ситуацій.
          </p>
          <div className="my-4">
